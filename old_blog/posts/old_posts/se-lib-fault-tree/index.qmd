...
The `se-lib` (*Systems Engineering Library*) offers a variety of diagrams that simply take in tuples of strings and numbers. In this post I want to discuss their [quantitative fault tree](http://se-lib.org/examples.html#quantitative-fault-tree) diagrams.
...
| $Q$ | Hospital-Acquired Infection | 0.03 |
...
The first AND gate (going from left-to-right) is the one which produces the probability for a medication error. You'll note that the propositions
