...
| `libncurses5-dev` | Transitional package for `libncurses-dev` | [Package prociding `libncurses5-dev`.](https://packages.ubuntu.com/focal/libncurses5-dev) |
...
| `libffi-dev` | Foreign Function Interface library (development files) | [This package contains the headers and static library files necessary for building programs which use libffi](https://packages.debian.org/buster/libffi-dev) |
