...
when `GET` is used. If the method is `POST`, then the page will render `"POST"`. Otherwise the function implicitly returns `None`, which offhand I don't think does much of anything.
