...
author: "Galen Seilis"
date: "2023-03-03"
categories: [Math, Graph Theory, Graphlets, Automorphisms, Automorphism Orbits, Automorphism Orbits of Graphlets, Isomorphisms, Graphs, Relations, Binary Relations, Sets, Vertices, Edges, Subsets, Cartesian Products, Networks, directed Graphs, Digraphs, Signed Graphs, Weighted Graphs, Simple Graphs, Functions, Injective Functions, Surjective Functions, Bijective Functions, Graph Isomorphism, Graph Automorphisms, Equivalence Relations, Reflexive Relations, Symmetric Relations, Transitive Relations, Equivalence Classes, Vertex Orbit Automorphisms, Permutation Groups]
---

Back in May 2020 I released a video on YouTube for the HackSeq event:

<iframe width="560" height="315" src="https://www.youtube.com/embed/vY1UkCPSKH8?si=5wooO7lIT8DMe32f" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
