...
[Wikipedia](https://en.wikipedia.org/wiki/Poisson_binomial_distribution#Probability_Mass_Function) gives pseudocode for computing the probability mass function for the Poisson binomial distribution via what it terms the "direct convolution algorithm". The algorithm works by iteratively
