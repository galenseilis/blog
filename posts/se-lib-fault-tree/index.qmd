...
for any choice of measure $\mu$. This might look very similar to the disjoint case that we just covered. However, they are not the same. See @590864 for some examples, noting that for our purposes we would take $\mu$ to be a probability measure.
