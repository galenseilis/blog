...
As long as the linking and compiled options are kept simple, this script allows you to compile simple C language programs. This may be suitable for ensuring that C code examples for blogging actually work. Expanding into autotools and make files is the way to go for more complicated builds.
