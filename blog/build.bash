...
echo "$(date): 0001: Building dependency graph of de-Kedro-ed spaceflights example module imports..."
uvx pydeps \
  ./posts/0001-python-modules-can-pass-data-too/spaceflights_pandas/ \
  --no-output \
  --show-dot |
  dot -Tpng -Gdpi=300 -o ./posts/0001-python-modules-can-pass-data-too/analysis_spaceflights_pandas/dependency_graph.png
echo "done"
