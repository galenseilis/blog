...
# NOTE: at this point we 'could' just reuse the functions they're specified. Copy them into another module and then import them. However, some of these functions look like they can be largely replaced by a few pandas method chains... Let's see...
...
model_input_table = (
    processed_shuttles
    .merge(spaceflights_pandas.datasets.reviews.data, left_on="id", right_on="shuttle_id")
    .drop(columns="id")
